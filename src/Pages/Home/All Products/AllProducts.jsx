...
const AllProducts = () => {
  ...
  return (
    <div className='min-h-screen pb-20'>
      <div className='max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 mt-20'>
        {
          products?.map(product => (
            <div key={product._id} class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div class="pt-6">
                <div class="mb-4 flex items-center justify-between gap-4">
                  <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> {product.date} </span>

                  <div class="flex items-center justify-end gap-1">
                    <button type="button" data-tooltip-target="tooltip-quick-look" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white">
                ...
                <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline">{product.itemName}</a>
                ...
                <div class="mt-4 flex items-center justify-between gap-4">
                  <p class="text-2xl font-extrabold leading-tight text-gray-900">${product.pricePerUnit}</p>

                  <button type="button" class="inline-flex items-center rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300">
