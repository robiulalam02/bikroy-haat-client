...
const ManageWatchlist = () => {
    ...
    // if (error) {
    //     return <div className="text-center py-8 text-red-500">Error: {error?.message || "Failed to load watchlists."}</div>;
    // }
        ...
        <div className='p-4'>
            {
                watchlists?.length === 0 || !watchlists ?
                    <p className='text-error text-center'>No products in Watchlist</p>
                    :
