...
import { PiBell, PiBellThin } from 'react-icons/pi';
  ...
  return (
    <StyledWrapper>
      <div className="button-container">
        ...
        <button className="button" onClick={()=> navigate('/dashboard/profile')}>
        ...
        <button className="button" onClick={()=> navigate('/all-products')}>
