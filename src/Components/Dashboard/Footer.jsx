...
const Footer = () => {
    return (
        <footer className="bg-white border-t border-gray-200 shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 antialiased">
            <p className="mb-4 text-sm text-center text-gray-500  sm:mb-0">
                &copy; 2024-2025 <a href="https://flowbite.com/" className="hover:underline" target="_blank">Bikroy Haat</a>. All rights reserved.
            </p>
            <div className="flex justify-center items-center space-x-1">
                <a href="https://www.facebook.com/shopneel10" target='_blank' data-tooltip-target="tooltip-facebook" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer  dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <a href="https://x.com/shopneel_10" target='_blank' data-tooltip-target="tooltip-twitter" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <a href="https://github.com/robiulalam02" target='_blank' data-tooltip-target="tooltip-github" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
